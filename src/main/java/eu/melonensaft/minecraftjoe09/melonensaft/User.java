 ...
 */
public interface User extends HumanEntity, Conversable, OfflinePlayer, PluginMessageRecipient {
     ...
     * @deprecated see {@link #hidePlayer(Plugin, org.bukkit.entity.Player)}
     */
    @Deprecated
    public void hidePlayer(@NotNull org.bukkit.entity.Player player);
     ...
     * @param player Player to hide
     */
    public void hidePlayer(@NotNull Plugin plugin, @NotNull org.bukkit.entity.Player player);

    /**
     * Allows this player to see a player that was previously hidden
     *
     * @param player Player to show
     * @deprecated see {@link #showPlayer(Plugin, org.bukkit.entity.Player)}
     */
    @Deprecated
    public void showPlayer(@NotNull org.bukkit.entity.Player player);
     ...
     * @param player Player to show
     */
    public void showPlayer(@NotNull Plugin plugin, @NotNull org.bukkit.entity.Player player);
     ...
     *     player
     */
    public boolean canSee(@NotNull org.bukkit.entity.Player player);
    ...
    // Spigot start
    public class MelonenSaft extends Entity.Spigot {
         ...
         */
        @NotNull
        public java.util.Set<org.bukkit.entity.Player> getHiddenPlayers() {
            throw new UnsupportedOperationException("Not supported yet.");
        }
